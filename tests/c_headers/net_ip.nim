...
type
  net_ip_protocol* {.size: sizeof(cint).} = enum
...
type
  net_ip_protocol_secure* {.size: sizeof(cint).} = enum
...
type
  net_sock_type* {.size: sizeof(cint).} = enum
...
when defined(CONFIG_NET_IPV4):
  const
    NET_SOCKADDR_MAX_SIZE* = (sizeof(sockaddr_in))
    NET_SOCKADDR_PTR_MAX_SIZE* = (sizeof(sockaddr_in_ptr))
when defined(CONFIG_NET_SOCKETS_PACKET):
  const
    NET_SOCKADDR_MAX_SIZE* = (sizeof(sockaddr_ll))
    NET_SOCKADDR_PTR_MAX_SIZE* = (sizeof(sockaddr_ll_ptr))
when defined(CONFIG_NET_IPV6):
  const
    NET_SOCKADDR_MAX_SIZE* = (sizeof(sockaddr_in6))
  when not defined(CONFIG_NET_SOCKETS_PACKET):
    const
      NET_SOCKADDR_PTR_MAX_SIZE* = (sizeof(sockaddr_in6_ptr))
...
type
  net_priority* {.size: sizeof(cint).} = enum
...
type
  net_addr_state* {.size: sizeof(cint).} = enum
...
type
  net_addr_type* {.size: sizeof(cint).} = enum ## * Default value. This is not a valid value.
...
type
  net_ipv6_hdr* {.importc: "net_ipv6_hdr", header: "net_ip.h", bycopy.} = object
...
var __packed* {.importc: "__packed", header: "net_ip.h".}: net_ipv6_hdr

type
  net_ipv6_frag_hdr* {.importc: "net_ipv6_frag_hdr", header: "net_ip.h", bycopy.} = object
    nexthdr* {.importc: "nexthdr".}: uint8
...
var __packed* {.importc: "__packed", header: "net_ip.h".}: net_ipv6_frag_hdr

type
  net_ipv4_hdr* {.importc: "net_ipv4_hdr", header: "net_ip.h", bycopy.} = object
...
var __packed* {.importc: "__packed", header: "net_ip.h".}: net_ipv4_hdr

type
  net_icmp_hdr* {.importc: "net_icmp_hdr", header: "net_ip.h", bycopy.} = object
    `type`* {.importc: "type".}: uint8
    code* {.importc: "code".}: uint8
    chksum* {.importc: "chksum".}: uint16


var __packed* {.importc: "__packed", header: "net_ip.h".}: net_icmp_hdr

type
  net_udp_hdr* {.importc: "net_udp_hdr", header: "net_ip.h", bycopy.} = object
...
var __packed* {.importc: "__packed", header: "net_ip.h".}: net_udp_hdr

type
  net_tcp_hdr* {.importc: "net_tcp_hdr", header: "net_ip.h", bycopy.} = object
    src_port* {.importc: "src_port".}: uint16
    dst_port* {.importc: "dst_port".}: uint16
...
var __packed* {.importc: "__packed", header: "net_ip.h".}: net_tcp_hdr
...
const
  ...
  NET_IPV6H_LENGTH_OFFSET* = 0x04
  NET_IPV6_FRAGH_OFFSET_MASK* = 0xfff8
