...
struct net_tcp_hdr {
 ...
 const char *net_addr_type2str(enum net_addr_type type)
{
	switch (type) {
 ...
 */
 bool net_ipv6_is_addr_loopback(struct in6_addr *addr)
{
 ...
 */
 bool net_ipv6_is_addr_mcast(const struct in6_addr *addr)
{
 ...
 */
 bool net_ipv6_is_my_addr(struct in6_addr *addr)
{
 ...
 * @return True if address was found, False otherwise.
 */
 bool net_ipv6_is_my_maddr(struct in6_addr *maddr)
{
 ...
 */
 bool net_ipv6_is_prefix(const uint8_t *addr1,
				      const uint8_t *addr2,
				      uint8_t length)
{
 ...
 * @return True if address is a loopback address, False otherwise.
 */
 bool net_ipv4_is_addr_loopback(struct in_addr *addr)
{
 ...
 */
 bool net_ipv4_is_addr_unspecified(const struct in_addr *addr)
{
 ...
 * @return True if address is multicast address, False otherwise.
 */
 bool net_ipv4_is_addr_mcast(const struct in_addr *addr)
{
 ...
 */
 bool net_ipv4_addr_cmp(const struct in_addr *addr1,
 ...
 *  @return True if the addresses are the same, false otherwise.
 */
 bool net_ipv6_addr_cmp(const struct in6_addr *addr1,
 ...
 * @return True if it is, false otherwise.
 */
 bool net_ipv6_is_ll_addr(const struct in6_addr *addr)
{
 ...
 * @return True if it is, false otherwise.
 */
 bool net_ipv6_is_ula_addr(const struct in6_addr *addr)
{
 ...
 */
 bool net_ipv4_addr_mask_cmp(struct net_if *iface,
					  const struct in_addr *addr)
{
 ...
 */
 ...
 bool net_ipv4_is_addr_bcast(struct net_if *iface,
					  const struct in_addr *addr)
{
 ...
 * False otherwise.
 */
 bool net_ipv4_is_my_addr(const struct in_addr *addr)
{
	bool ret;
 ...
 *  @return True if the address is unspecified, false otherwise.
 */
 bool net_ipv6_is_addr_unspecified(const struct in6_addr *addr)
{
	return UNALIGNED_GET(&addr->s6_addr32[0]) == 0 &&
		UNALIGNED_GET(&addr->s6_addr32[1]) == 0 &&
		UNALIGNED_GET(&addr->s6_addr32[2]) == 0 &&
 ...
 */
 bool net_ipv6_is_addr_solicited_node(const struct in6_addr *addr)
{
 ...
 * false otherwise.
 */
 bool net_ipv6_is_addr_mcast_scope(const struct in6_addr *addr,
						int scope)
{
 ...
 * false otherwise.
 */
 bool net_ipv6_is_same_mcast_scope(const struct in6_addr *addr_1,
 ...
 */
 bool net_ipv6_is_addr_mcast_global(const struct in6_addr *addr)
{
 ...
 * false otherwise.
 */
 bool net_ipv6_is_addr_mcast_iface(const struct in6_addr *addr)
{
 ...
 * false otherwise.
 */
 bool net_ipv6_is_addr_mcast_link(const struct in6_addr *addr)
{
 ...
 * false otherwise.
 */
 bool net_ipv6_is_addr_mcast_mesh(const struct in6_addr *addr)
{
 ...
 * false otherwise.
 */
 bool net_ipv6_is_addr_mcast_site(const struct in6_addr *addr)
{
 ...
 * false otherwise.
 */
 bool net_ipv6_is_addr_mcast_org(const struct in6_addr *addr)
{
 ...
 */
 bool net_ipv6_is_addr_mcast_group(const struct in6_addr *addr,
...
{
	 const struct in6_addr all_nodes_mcast_group = {
 ...
 */
 void net_ipv6_addr_create(struct in6_addr *addr,
 ...
 *  @param addr IPv6 address
 */
 void net_ipv6_addr_create_ll_allnodes_mcast(struct in6_addr *addr)
{
 ...
 *  @param addr IPv6 address
 */
 void net_ipv6_addr_create_ll_allrouters_mcast(struct in6_addr *addr)
{
 ...
 */
 void net_ipv6_addr_create_iid(struct in6_addr *addr,
 ...
 *  @return True if it is, False otherwise
 */
 bool net_ipv6_addr_based_on_ll(const struct in6_addr *addr,
 ...
 */
 struct sockaddr_in6 *net_sin6(const struct sockaddr *addr)
{
 ...
 */
 struct sockaddr_in *net_sin(const struct sockaddr *addr)
{
 ...
 */
 int32_t net_tcp_seq_cmp(uint32_t seq1, uint32_t seq2)
{
 ...
 */
 bool net_tcp_seq_greater(uint32_t seq1, uint32_t seq2)
{
 ...
 */
 enum net_priority net_vlan2priority(uint8_t priority)
{
	/* Map according to IEEE 802.1Q */
	 const uint8_t vlan2priority[] = {
		NET_PRIORITY_BE,
		NET_PRIORITY_BK,
		NET_PRIORITY_EE,
		NET_PRIORITY_CA,
 ...
 */
 uint8_t net_priority2vlan(enum net_priority priority)
{
