...
export zkernel_fixes, zdevice, zkernel, zk_locks
...
proc nvs_read_hist*(fs: ptr nvs_fs; id: uint16; data: pointer; len: cint;
                   cnt: uint16): cint {.importc: "nvs_read_hist",
    header: hdr.} ##\
...
proc nvs_calc_free_space*(fs: ptr nvs_fs): cint {.importc: "nvs_calc_free_space",
    header: hdr.} ##\
